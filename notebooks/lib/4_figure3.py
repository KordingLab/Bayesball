...
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure3","Figure3A-1.svg"))
...
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure3","Figure3A-2.svg"))
...
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure3","Figure3A-3.svg"))
...
# Save the simulation for figure 3 A
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure3","Figure3B.svg"))
