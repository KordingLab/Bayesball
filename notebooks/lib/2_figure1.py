...
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure1","Figure1A.svg"))
...
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure1","Figure1B.svg"))
...
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure1","Figure1C.svg"))
...
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure1","Figure1D-1.svg"))
...
# Save the full figure 1D
fig.savefig(os.path.join(os.getcwd(),"figure_parts","figure1","Figure1D-2.svg"))
